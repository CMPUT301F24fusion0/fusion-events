...
public class AppNotifications {
    ...
    public void permission(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            if (!(ActivityCompat.checkSelfPermission(activity, Manifest.permission.POST_NOTIFICATIONS) == PackageManager.PERMISSION_GRANTED)) {
                Log.e("Error", "Notifications not granted");
            } else {
     ...
     */
    public void sendNotification(String dID, String title, String body) {
    ...
    private void sendAllNotifications(String dID, Context context, ArrayList<String> notifications) {
     ...
     */
    public void getNotification(String dID, Context context) {
